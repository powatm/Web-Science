$(document).ready(function () {
    ...
    hash_arr=jQuery.unique(hash_arr);
    for(var i=0;i<hash_arr.length&&i<5;i++){
       var trend1="<li id= 'tr"+(i)+"'>#"+hash_arr[i]+"</li>";
       $("#trends").append(trend1);
       var tr_id= document.getElementById("tr"+(i));     
     }
              
    //tweet ticker
    var next_tweet=1;
    var next_count=1;
    if(tweet_arr.length>=5){
